...
const validarDatasReserva = (dataInicial, dataFinal) => {
    ...
    if (dataInicio <= hoje) {
        return {
            ehValida: false,
            motivo: 'ERRO: A data inicial deve ser maior que hoje.',
        };
    }
    ...
    if (dataFim <= dataInicio) {
        return {
            ehValida: false,
            motivo: 'ERRO: A data final deve ser maior que a data inicial.',
        };
    }
    ...
    if (diasDeDiferenca > 30) {
        return {
            ehValida: false,
            motivo: 'ERRO: O intervalo máximo entre a data inicial e a data final deve ser de 30 dias corridos.',
        };
    }
